...
@registry.register_processor("blip2_rs_train")
class Blip2ImageTrainProcessor(BaseProcessor):
    def __init__(
            self, image_size=256, mean=None, std=None
    ):
        super().__init__()

        if mean is None:
            mean = [0.3584, 0.3111, 0.2654, 0.2578, 0.3299, 0.3653, 0.3547, 0.2965, 0.2266]
        if std is None:
            std = [0.064, 0.072, 0.0095, 0.048, 0.067, 0.080, 0.085, 0.074, 0.060]
