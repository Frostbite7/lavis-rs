...
from lavis.datasets.datasets.rs_datasets import (
    RSCaptionDataset,
    RSCaptionEvalDataset,
)
...
@registry.register_builder("rs_caption")
class RSCapBuilder(BaseDatasetBuilder):
    train_dataset_cls = RSCaptionDataset
    eval_dataset_cls = RSCaptionEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/rs/defaults_cap.yaml",
    }
